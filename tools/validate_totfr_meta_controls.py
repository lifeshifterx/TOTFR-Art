...
for tok in ['control-plane-integrity','python tools/validate_totfr_meta_controls.py','python tools/test_totfr_meta_controls.py','python tools/validate_totfr_live_protection.py','cancel-in-progress: true']:
...
for p in [ROOT/'tools/validate_totfr_runtime_trust.py',ROOT/'tools/test_totfr_runtime_trust.py',ROOT/'tools/validate_totfr_live_protection.py',ROOT/'tools/validate_totfr_meta_controls.py',ROOT/'tools/test_totfr_meta_controls.py']:
...
print('END-OF-FILE SENTINEL: TOTFR-META-CONTROL-VALIDATOR-2026-09-04-V2')
